defmodule Observer.Web.Components.Metrics.VmSchedulerUtilization do
  @moduledoc false
  ...
  attr :supported_metrics, :list, default: ["vm.scheduler.utilization"]
    ...
    {series_data, categories_data} =
      Enum.reduce(metrics, {[], []}, fn
        ...
        metric, {series_data, categories_data} ->
          ...
          {[Float.round(metric.value / 1, 2)] ++ series_data, [timestamp] ++ categories_data}
      end)
