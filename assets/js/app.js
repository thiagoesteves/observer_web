...
hooks.ObserverEChart = {
  ...
  updated() {
    ...
    if (this.previousSeries && JSON.stringify(this.previousSeries) === JSON.stringify(dataConfig.series)) {
    ...
    this.previousSeries = dataConfig.series;
    ...
    this.chart.setOption(dataConfig, notMerge)
  }
}
